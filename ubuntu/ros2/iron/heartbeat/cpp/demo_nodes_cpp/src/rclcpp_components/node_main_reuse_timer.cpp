...
#define NODE_MAIN_LOGGER_NAME "reuse_timer"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libreuse_timer_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::ReuseTimerNode>";
