...
#define NODE_MAIN_LOGGER_NAME "introspection_client"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libintrospection_client_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::IntrospectionClientNode>";
