...
#define NODE_MAIN_LOGGER_NAME "parameter_events_async"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libparameter_events_async_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::ParameterEventsAsyncNode>";
