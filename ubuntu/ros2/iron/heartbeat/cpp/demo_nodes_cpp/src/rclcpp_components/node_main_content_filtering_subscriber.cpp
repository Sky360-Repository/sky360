...
#define NODE_MAIN_LOGGER_NAME "content_filtering_subscriber"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcontent_filtering_subscriber_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::ContentFilteringSubscriber>";
