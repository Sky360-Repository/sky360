...
#define NODE_MAIN_LOGGER_NAME "parameter_blackboard"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libparameter_blackboard_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::ParameterBlackboard>";
