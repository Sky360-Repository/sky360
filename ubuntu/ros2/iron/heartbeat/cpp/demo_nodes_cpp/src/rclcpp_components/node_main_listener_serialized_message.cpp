...
#define NODE_MAIN_LOGGER_NAME "listener_serialized_message"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblistener_serialized_message_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::SerializedMessageListener>";
