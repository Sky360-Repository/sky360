...
#define NODE_MAIN_LOGGER_NAME "list_parameters"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblist_parameters_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::ListParameters>";
