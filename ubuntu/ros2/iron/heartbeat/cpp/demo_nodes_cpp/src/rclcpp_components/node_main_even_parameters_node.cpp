...
#define NODE_MAIN_LOGGER_NAME "even_parameters_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libeven_parameters_node_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::EvenParameterNode>";
