...
#define NODE_MAIN_LOGGER_NAME "content_filtering_publisher"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcontent_filtering_publisher_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::ContentFilteringPublisher>";
