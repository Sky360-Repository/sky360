...
#define NODE_MAIN_LOGGER_NAME "listener_best_effort"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblistener_best_effort_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::ListenerBestEffort>";
