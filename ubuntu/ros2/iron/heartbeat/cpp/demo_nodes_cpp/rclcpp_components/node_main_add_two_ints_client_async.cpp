...
#define NODE_MAIN_LOGGER_NAME "add_two_ints_client_async"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libadd_two_ints_client_async_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::ClientNode>";
