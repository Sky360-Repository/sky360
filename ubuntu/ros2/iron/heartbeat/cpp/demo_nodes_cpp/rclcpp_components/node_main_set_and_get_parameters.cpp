...
#define NODE_MAIN_LOGGER_NAME "set_and_get_parameters"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libset_and_get_parameters_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::SetAndGetParameters>";
