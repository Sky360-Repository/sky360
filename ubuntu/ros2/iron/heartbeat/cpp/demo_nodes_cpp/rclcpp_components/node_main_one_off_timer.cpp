...
#define NODE_MAIN_LOGGER_NAME "one_off_timer"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libone_off_timer_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::OneOffTimerNode>";
