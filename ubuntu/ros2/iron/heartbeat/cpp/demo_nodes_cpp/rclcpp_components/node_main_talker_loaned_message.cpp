...
#define NODE_MAIN_LOGGER_NAME "talker_loaned_message"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtalker_loaned_message_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::LoanedMessageTalker>";
