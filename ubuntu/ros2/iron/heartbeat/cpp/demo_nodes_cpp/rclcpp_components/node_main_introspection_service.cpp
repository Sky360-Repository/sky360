...
#define NODE_MAIN_LOGGER_NAME "introspection_service"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libintrospection_service_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::IntrospectionServiceNode>";
