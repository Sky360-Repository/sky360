...
#define NODE_MAIN_LOGGER_NAME "set_parameters_callback"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libset_parameters_callback_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::SetParametersCallback>";
