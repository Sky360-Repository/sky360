...
namespace sky360lib::tracking
{
     ...
     */
    class TrackerCSRTModel final : public TrackerModel
    {
    public:
        TrackerCSRTModel() {}
        ~TrackerCSRTModel() {}
    ...
    protected:
        void modelEstimationImpl(const std::vector<Mat> & /*responses*/) override {}
        void modelUpdateImpl() override {}
    };

    class TrackerCSRTImpl final : public TrackerCSRT
    {
    public:
    ...
    public:
        ParallelCreateCSRFilter(
            ...
            const cv::Mat P,
            int admm_iterations,
            std::vector<Mat> &result_filter_) : result_filter(result_filter_)
        {
